...
const services = [
  { id: 'mechanical', name: 'إصلاح ميكانيكي', name_en: 'Mechanical Repair', icon: 'https://cdn-icons-png.flaticon.com/512/2972/2972185.png' },
  { id: 'battery', name: 'بطارية وشحن', name_en: 'Battery & Charging', icon: 'https://cdn-icons-png.flaticon.com/512/869/869636.png' },
  { id: 'tires', name: 'فحص الإطارات', name_en: 'Tire Check', icon: 'https://cdn-icons-png.flaticon.com/512/7430/7430163.png' },
  ...
  { id: 'tech_support', name: 'دعم تقني', name_en: 'Tech Support', icon: 'https://cdn-icons-png.flaticon.com/512/2704/2704319.png' },
];
