...
const services = [
  { id: 'mechanical', name: 'إصلاح ميكانيكي', name_en: 'Mechanical Repair', icon: 'https://cdn-icons-png.flaticon.com/512/4635/4635363.png' },
  { id: 'battery', name: 'بطارية وشحن', name_en: 'Battery & Charging', icon: 'https://cdn-icons-png.flaticon.com/512/3071/3071441.png' },
  { id: 'tires', name: 'فحص الإطارات', name_en: 'Tire Check', icon: 'https://cdn-icons-png.flaticon.com/512/10755/10755050.png' },
  { id: 'electronic', name: 'فحص إلكتروني', name_en: 'Electronic Check', icon: 'https://cdn-icons-png.flaticon.com/512/3202/3202926.png' },
  { id: 'fuel', name: 'تعبئة وقود', name_en: 'Fuel Refill', icon: 'https://cdn-icons-png.flaticon.com/512/2704/2704319.png' },
